...
export const StoryView: React.FC<StoryViewProps> = ({ onBack, isDarkMode }) => {
  ...
  return (
    <div 
      ...
      style={{
        backgroundColor: isMagicActive 
          ? '#050510' // Deep dark for magic lens
          : (isDarkMode ? '#0f172a' : '#f8fafc') // Slate 900 or Slate 50
      }}
    >
